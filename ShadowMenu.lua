...
-- ── Cria BillboardGui ancorado numa parte do personagem ──────────
...
local function createEspForPlayer(plr)
    ...
    -- ── ESP NAME — BillboardGui na cabeça, acima dela ────────────
    ...
    -- ── ESP RAGE — BillboardGui na cabeça, acima do NAME ─────────
    ...
    -- ── ESP BOX — BillboardGui no HRP, centrado no corpo ─────────
    -- Usamos 4 frames dentro de 1 BillboardGui para nunca derivar
    local boxBB = makeBillboard(hrp, Vector3.new(0, 0, 0), 80, 120)
    boxBB.Name = "ESPBox"
    boxBB.Size = UDim2.new(0, 80, 0, 120) -- ajustado no loop
    ...
    -- Trace usa worldToScreen pois vai do topo da tela até a cabeça
    ...
    -- ── ESP LIFE — BillboardGui no HRP, lado direito do box ──────
    ...
    -- ── ESP HEAD — BillboardGui na cabeça, círculo semiopaco ─────
